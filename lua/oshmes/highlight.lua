...
M.load = function(theme)
  return {
    ...
    DiffAdd                     = { bg = utils.mixColors(theme.colors.green, theme.colors.background, 0.9) },
    DiffAdded                   = "DiffAdd",
    DiffChange                  = { bg = utils.mixColors(theme.colors.blue, theme.colors.background, 0.85) },
    DiffChangeDelete            = { fg = theme.colors.red, },
    DiffModified                = { fg = theme.colors.yellow, },
    DiffDelete                  = { bg = utils.mixColors(theme.colors.red, theme.colors.background, 0.9), },
    DiffRemoved                 = "DiffDelete",
    DiffText                    = { bg = utils.mixColors(theme.colors.blue, theme.colors.background, 0.8) },
